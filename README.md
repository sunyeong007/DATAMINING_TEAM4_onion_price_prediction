...
2. 1에서 합쳐진 데이터 파일을 eda.ipynb를 실행해 변수의 특징 및 상관관계를 살펴본다.
3. 2013년이후_6개월단위예측 폴더에 저장된 데이터로 한달후예측.ipynb를 실행하면 예측 결과가 저장된다.
4. 2020년이후_1개월단위예측 폴더에 저장된 데이터로 6개월후예측.ipynb를 실행하면 예측 결과가 저장된다.
